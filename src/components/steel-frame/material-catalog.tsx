    ...
    <div className="space-y-5">
      <Card className="border-primary/10 bg-secondary/20">
        <CardContent className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2"><Button asChild variant="outline"><Link href="/estimates/catalog/suppliers"><Building2 className="size-4" /> Fornecedores</Link></Button><Button asChild variant="outline"><Link href="/estimates/catalog/technical"><BookMarked className="size-4" /> Modelos tecnicos</Link></Button><Button asChild variant="outline"><Link href="/estimates/catalog/sources"><BookOpenText className="size-4" /> Biblioteca tecnica</Link></Button><Button asChild variant="outline"><Link href="/estimates/catalog/supplier-quotes"><ReceiptText className="size-4" /> Cotacoes</Link></Button></div>
        </CardContent>
      </Card>
