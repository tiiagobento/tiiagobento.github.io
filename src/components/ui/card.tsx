...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("rounded-xl border border-border/80 bg-card/95 text-card-foreground shadow-sm shadow-slate-950/[0.045] backdrop-blur-sm", className)} {...props} />;
}
